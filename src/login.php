...
<!----------------------------------------- HEAD ----------------------------------------------------->
    <head>
        ...
        <title>Aetech - Iniciar Sesión</title>
    ...
    <section class="seccion_login d-flex justify-content-center">
        <div class="justify-content-center m-3">
            ...
            <!------------- Boton Contra Olvidada --------------->
                <div class="d-flex justify-content-center">
                    <button type="button" class="boton_solo_texto" data-toggle="modal" data-target="#exampleModal">¿Has olvidado tu contraseña?</button>
                </div>
            <!--------------------------------------------------->
            <!--------------------------------------------------->
            </div>
