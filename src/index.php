...
<!----------------------------------------- HEAD ----------------------------------------------------->
    <head>
        ...
        <title>Aetech - Inicio</title>
        <link rel="icon" href="../src/images/logo_AETECH2.png">
...
<!---------------------------------------- SECCION 1 ------------------------------------------------->
        <section class="seccion_landing_inicio d-flex justify-content-center">
           ...
           <div class="m-4 div_landing_imagen_robot">
               <img class="imagen_robot" src="../src/images/turtlebot3-burger.png" alt="imagen_robot">
           </div>
            <!--------------------------------------------------->
           ...
           <ul class="d-flex justify-content-center paneles">
               <li class="panel panel-flip m-2">
                   <div class="flip-card-front">
                       <img class="iconos" src="../src/images/consultas_icono.png" alt="Icono Consultar">
               ...
               <li class="panel panel-flip m-2">
                   <div class="flip-card-front">
                       <img class="iconos" src="../src/images/integracion_icono.png" alt="Icono Integrar">
               ...
               <li class="panel panel-flip m-2">
                   <div class="flip-card-front">
                       <img class="iconos" src="../src/images/guia_icono.png" alt="Icono Guiar">
               ...
               <li class="panel panel-flip m-2">
                   <div class="flip-card-front">
                       <img class="iconos" src="../src/images/registro_icono.png" alt="Icono Registrar Empleados">
...
<!---------------------------------------- SECCION 3 ------------------------------------------------->
        <section class="seccion_landing_fun_web">
            ...
            <div class="div_landing_fun_web d-flex justify-content-center align-items-center">
                <img class="imagen_fun_web" src="../src/images/ordenador_icono.png" alt="icono_ordenador">
            ...
            <div class="d-flex div_listado_fun_web">
                <ul class="d-block">
                    <li class="d-flex justify-content-center">
                        <div class="d-flex align-items-center">
                            <img class="iconos_fun_web" src="../src/images/desplazar_icono.png" alt="Icono desplazar">
                        </div>
                        <div class="m-3">
                    ...
                    <li class="d-flex justify-content-center">
                        <div class="d-flex align-items-center">
                            <img class="iconos_fun_web" src="../src/images/ubicacion_icono.png" alt="Icono ubicacion">
                        </div>
                        <div class="m-3">
                ...
                <ul class="d-block">
                    <li class="d-flex justify-content-center">
                        <div class="d-flex align-items-center">
                            <img class="iconos_fun_web" src="../src/images/estado_icono.png" alt="Icono desplazar">
                        </div>
                        <div class="m-3">
                    ...
                    <li class="d-flex justify-content-center">
                        <div class="d-flex align-items-center">
                            <img class="iconos_fun_web" src="../src/images/horarios_icono.png" alt="Icono ubicacion">
                        </div>
                        <div class="m-3">
