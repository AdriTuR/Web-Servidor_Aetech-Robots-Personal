...
<!----------------------------------------SECCIÓN 1--------------------------------------------------->
    <section class="seccion_acerca_inicio d-flex justify-content-center">
        ...
        <div class="div_acerca_imagen_logo">
            <img class="imagen_logo_aetech m-4" src="../src/images/logo_AETECH.png" alt="imagen_logo_aetech">
        </div>
        <!--------------------------------------------------->
        <!--------------------------------------------------->
        ...
        <ul class="d-flex justify-content-center paneles">
            <li class="panel panel-flip m-2">
                <div class="flip-card-front">
                    <img class="iconos" src="../src/images/innovacion_icono.png" alt="Icono Inovacción">
            ...
            <li class="panel panel-flip m-2">
                <div class="flip-card-front">
                    <img class="iconos" src="../src/images/calidad_icono.png" alt="Icono Calidad">
            ...
            <li class="panel panel-flip m-2">
                <div class="flip-card-front">
                    <img class="iconos" src="../src/images/dedicacion_icono.png" alt="Icono dedicación">
            ...
            <li class="panel panel-flip m-2">
                <div class="flip-card-front">
                    <img class="iconos" src="../src/images/mejorar_icono.png" alt="Icono mejorar">
